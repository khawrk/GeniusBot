                ...
                <div>
                    < div className="bg-navy-bg w-full h-[60px] border-navy-bg rounded-t-lg flex gap-1 p-1 justify-evenly relative" >
                        <div className="w-[30%] mr-1 flex justify-center">
                            <img src={ChatbotIcon} alt="chatbot icon" className=" bordor-cream-bg border-[1px] rounded-full m-1 p-1" />
                        </div>
                        <div className="flex justify-start flex-col mt-1 mx-0 w-full">
                            <h3 className="font-bold text-start text-[14px]">Hi {name}</h3>
                            <h3 className="text-start text-[12px] p-0">You are chatting with GeniusBot</h3>
                        </div>
